---
title: "Sample_Topic_Model_script"
author: "Trish Goedecke"
date: "10/14/2018"
...
# rm(list=ls()) # clear all global variables ~ use with care
...
```{r simple, echo=FALSE, include=TRUE}
...
## 5-fold cross validation to determine number of topics (K)


```{r crossval, echo=FALSE, include=TRUE}
